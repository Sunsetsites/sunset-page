...
export function Depoiments() {
  ...
  return (
    <div className="relative overflow-hidden bg-primary-color lg:[clip-path:polygon(0_0,45%_0,60%_80px,100%_80px,100%_100%,0_100%)] text-white pt-20 md:pt-40 pb-20  flex flex-col lg:flex-row justify-between mt-20 px-4 md:px-10 lg:px-30">
      ...
      <Swipper
        className="relative z-10 ml-auto flex w-full lg:max-w-lg flex-col gap-6"
        autoplay={true}
        freeMode={{
          enabled: true,
          momentum: false,
